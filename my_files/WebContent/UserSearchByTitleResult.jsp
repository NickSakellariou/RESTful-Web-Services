...
<link rel="stylesheet" type="text/css" href="UserSearchByTitleResult.css">

<title>Search books by the title result</title>
</head>
<body>
...
<%
	...
	WebResource webResource = client.resource(("http://localhost:8080/booktime/rest/booktimeService/SearchByTitle/"+title).replace(" ", "+"));
	...
	if(output.equals("[]")){
		%>
		<h2>There is no book with this title.</h2>
		<hr>
		<br>
		<%	
	}
