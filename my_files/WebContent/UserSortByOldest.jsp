...
<link rel="stylesheet" type="text/css" href="UserSortByOldest.css">
<title>All books sorted from oldest to newest</title>
</head>
<body>
<div class="header">
...
<div class="row1">
	...
	WebResource webResource = client.resource("http://localhost:8080/booktime/rest/booktimeService/AllBooksSortedByOldest");
	...
	if(output.equals("[]")){
		%>
		<h2>There are no books at the moment.</h2>
		<hr>
		<br>
		<%	
	}
	...
	%>
	<h2>All books sorted from oldest to newest : </h2>
	<hr>
