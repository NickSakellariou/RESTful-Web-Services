...
<link rel="stylesheet" type="text/css" href="ThirdPartyService2Result.css">
<title>Find the best seller books of a list result</title>
</head>
<body>
<div class="header">
...
<div class="row1">
	...
	WebResource webResource = client.resource(("https://api.nytimes.com/svc/books/v3/lists/current/"+list+".json?api-key=7PIgBT3XDdFGHk2CieoFgA0qpv990AqE").replace(" ", "-"));
	...
	if(output.equals("[]")){
		%>
		<h2>This list does not exist</h2>
		<hr>
		<br>
		<%	
	}
	...
	%>
	<h2>Best seller books of the list you typed</h2>
	<hr>
	...
	<form ACTION="BestSellerBooks.jsp" METHOD="POST">
