...
<link rel="stylesheet" type="text/css" href="UserSearchByYearResult.css">
<title>Search books by the year result</title>
</head>
<body>
...
int year = Integer.parseInt(request.getParameter("year"));
	...
	WebResource webResource = client.resource("http://localhost:8080/booktime/rest/booktimeService/SearchByYear/"+year);
	...
	if(output.equals("[]")){
		%>
		<h2>There is no book that was published that year.</h2>
		<hr>
		<br>
		<%	
	}
