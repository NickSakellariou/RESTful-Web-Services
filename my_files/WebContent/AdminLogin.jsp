...
<div class="row1">
	...
	<hr>
	<form ACTION="AdminLoginResult.jsp" METHOD="POST">
		...
		<input type="submit" class="btn btn-primary" value="Admin Login" name="submit">
	</form>
	
	<br>
	<br>
	<h2>Or register as admin if you haven't already</h2>
	<hr>
	...
	<input type="submit" class="btn btn-primary" value="Register as admin" name="submit">
</form>
</div>
