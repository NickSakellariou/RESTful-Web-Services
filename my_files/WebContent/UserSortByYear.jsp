...
<link rel="stylesheet" type="text/css" href="UserSortByYear.css">
<title>All books sorted from newest to oldest</title>
</head>
<body>
<div class="header">
...
<div class="row1">
	...
	WebResource webResource = client.resource("http://localhost:8080/booktime/rest/booktimeService/AllBooksSortedByYear");
	...
	%>
	<h2>All books sorted from newest to oldest : </h2>
	<hr>
