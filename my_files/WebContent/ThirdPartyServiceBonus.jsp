...
<link rel="stylesheet" type="text/css" href="ThirdPartyServiceBonus.css">
...
<div class="row1">
	...
	WebResource webResource = client.resource("https://official-joke-api.appspot.com/jokes/programming/random");
	...
	if(output.equals("[]")){
		%>
		<h2>There is no programming joke</h2>
		<hr>
		<br>
		<%	
	}
	...
	%>
	<form ACTION="ThirdPartyServiceBonus.jsp" METHOD="POST">
		<input type="submit" class="btn btn-primary" value="See another one" name="submit">
	</form>
	<br>
	<br>
