...
<link rel="stylesheet" type="text/css" href="UserSearchByAuthorResult.css">
<title>Search books by the author result</title>
</head>
<body>
<div class="header">
...
<%
	...
	WebResource webResource = client.resource(("http://localhost:8080/booktime/rest/booktimeService/SearchByAuthor/"+author).replace(" ", "+"));
	...
	if(output.equals("[]")){
		%>
		<h2>There is no book that was published by this author.</h2>
		<hr>
		<br>
		<%	
	}
	...
	<form ACTION="UserSearchBooks.jsp" METHOD="POST">
