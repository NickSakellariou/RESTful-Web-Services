...
<link rel="stylesheet" type="text/css" href="UserSortByPagesMore.css">
...
<%
	...
	WebResource webResource = client.resource("http://localhost:8080/booktime/rest/booktimeService/AllBooksSortedByPagesMore/"+pages);
	...
	if(output.equals("[]")){
		%>
		<h2>There is no book with more pages than you typed.</h2>
		<hr>
		<br>
		<%	
	}
