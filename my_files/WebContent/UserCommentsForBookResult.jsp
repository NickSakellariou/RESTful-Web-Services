...
<link rel="stylesheet" type="text/css" href="UserCommentsForBookResult.css">
<title>Find comments for books by title result</title>
</head>
<body>
<div class="header">
...
<%
	...
	WebResource webResource = client.resource(("http://localhost:8080/booktime/rest/booktimeService/CommentsForBook/"+title).replace(" ", "+"));
	...
	<form ACTION="UserCommentsForBook.jsp" METHOD="POST">
